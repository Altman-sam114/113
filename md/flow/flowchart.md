...
flowchart TD
    ...
    F -- 推理 --> G[ChatWorkspace<br/>顶部模型胶囊整体辅助语义<br/>会话 chip 动作语义<br/>会话 chip 删除触控目标<br/>会话 + 消息 + 输入<br/>聊天记录容器辅助语义<br/>聊天消息气泡辅助语义<br/>聊天气泡宽屏宽度策略<br/>composer 宽屏输入宽度策略<br/>SessionSidebarLayoutPolicy<br/>会话栏操作辅助语义<br/>会话栏操作 44pt 触控目标<br/>导出弹层分享/复制辅助语义<br/>导出弹层分享/复制 44pt 触控目标]

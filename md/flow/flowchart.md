...
flowchart TD
    ...
    F -- 模型 --> H[ModelLibraryView<br/>ModelLibraryLayoutMode<br/>窄屏单栏 / 宽屏内部双栏<br/>ModelDetailColumnLayoutPolicy<br/>详情右栏最大阅读宽度<br/>选择器/状态徽章/部署控件辅助语义<br/>模型文件工作流面板辅助语义<br/>卸载确认弹层辅助语义<br/>模型概要面板 + 详情右栏/行级辅助语义]
